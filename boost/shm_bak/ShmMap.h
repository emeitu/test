...
{
public:
    static const char* GetNamePrefix();
    static void SetNamePrefix(const char* prefix);
    static int GetSharedMemorySize();
    static void SetSharedMemorySize(int size);
    static const char* GetSharedMemoryName();
    static const char* GetSharedMutexName();
public:
    static const int MAX_NAME_LENGTH;
    static const char* DEFAULT_SHARED_MEMORY_NAME;
    static const int DEFAULT_SHARED_MEMORY_SIZE;
    static const char* DEFAULT_SHARED_MUTEX_NAME;
private:
    static std::string name_prefix;
    static std::string shared_memory_name;
    static std::string shared_mutex_name;
...
public:
    ShmMapHelper(const char* shared_memory_name = ShmMapConfig::GetSharedMemoryName(), int shared_memory_size=ShmMapConfig::GetSharedMemorySize(), const char* mutex_name=ShmMapConfig::GetSharedMutexName())
